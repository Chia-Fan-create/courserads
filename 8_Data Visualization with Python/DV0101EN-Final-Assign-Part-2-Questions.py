...
app.layout = html.Div([
    ...
    html.H1(children="Automobile Sales Statistics Dashboard", style = {'color':'#503D36' ,'font-size':24 } ), #Include style for title
    ...
    html.Div([
        html.Label("Select Year:"), # 加入標籤比較清晰
        dcc.Dropdown(
            id='select-year',
            # 修改這裡：label 應該等於 i
...
def update_output_container(selected_statistics, input_year):
    ...
    # ---------------------------------------------------------
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', 
                             title="Average Yearly Automobile Sales Trend"))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, values='Advertising_Expenditure', names='Vehicle_Type',
                             title='Total Advertisement Expenditure Share in {}'.format(input_year)))

        # 回傳 2x2 佈局 (統一使用 flex-wrap)
        return html.Div([
